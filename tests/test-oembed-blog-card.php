...
class OEmbed_Blog_Card_Test extends WP_UnitTestCase {
	...
	public function wordpress_site_link() {
		...
		$this->assertEquals(
			'<div class="js-wp-oembed-blog-card"><a class="js-wp-oembed-blog-card__link" href="https://2inc.org" target="_blank"></p><div class="wp-oembed-blog-card__body"><div class="wp-oembed-blog-card__content"><div class="wp-oembed-blog-card__description">https://2inc.org</div></div></div><p></a></div>',
